...
import { createUserRequestSchema, updateUserRequestSchema } from "../../zod/api/schema"
...
| `generates` | `array \| object` | Yes | Must include `"form"` |
...
Use the object form of `generates` to customize the output filename:
