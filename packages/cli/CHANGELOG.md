...
- 260daf9: Fix TypeScript compilation errors for ArkType and Effect validators:
...
- ecc8537: Add `url` field for GraphQL sources and `baseUrl` field for OpenAPI sources with environment variable support.
...
- fe05d16: Add Effect Schema as a fourth validation library option alongside Zod, Valibot, and ArkType.
